package cn.jonhon.jump.module.pay.service.order;
...
import cn.jonhon.jump.module.pay.framework.pay.core.client.PayClient;
...
import cn.jonhon.jump.module.pay.controller.admin.order.vo.PayOrderExportReqVO;
import cn.jonhon.jump.module.pay.controller.admin.order.vo.PayOrderPageReqVO;
import cn.jonhon.jump.module.pay.controller.admin.order.vo.PayOrderSubmitReqVO;
import cn.jonhon.jump.module.pay.controller.admin.order.vo.PayOrderSubmitRespVO;
import cn.jonhon.jump.module.pay.convert.order.PayOrderConvert;
import cn.jonhon.jump.module.pay.dal.dataobject.app.PayAppDO;
import cn.jonhon.jump.module.pay.dal.dataobject.channel.PayChannelDO;
import cn.jonhon.jump.module.pay.dal.dataobject.order.PayOrderDO;
import cn.jonhon.jump.module.pay.dal.dataobject.order.PayOrderExtensionDO;
import cn.jonhon.jump.module.pay.dal.mysql.order.PayOrderExtensionMapper;
import cn.jonhon.jump.module.pay.dal.mysql.order.PayOrderMapper;
import cn.jonhon.jump.module.pay.dal.redis.no.PayNoRedisDAO;
import cn.jonhon.jump.module.pay.enums.notify.PayNotifyTypeEnum;
import cn.jonhon.jump.module.pay.enums.order.PayOrderStatusEnum;
import cn.jonhon.jump.module.pay.framework.pay.config.PayProperties;
import cn.jonhon.jump.module.pay.service.app.PayAppService;
import cn.jonhon.jump.module.pay.service.channel.PayChannelService;
import cn.jonhon.jump.module.pay.service.notify.PayNotifyService;
...
import static cn.jonhon.jump.module.pay.enums.ErrorCodeConstants.*;
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://gitee.com/zhijiantianya/jonhonjump-cloud/issues/I8SM9H 场景
