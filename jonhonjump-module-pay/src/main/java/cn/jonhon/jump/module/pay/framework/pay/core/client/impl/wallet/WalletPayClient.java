package cn.jonhon.jump.module.pay.framework.pay.core.client.impl.wallet;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.map.MapUtil;
import cn.hutool.extra.spring.SpringUtil;
import cn.jonhon.jump.framework.common.exception.ServiceException;
import cn.jonhon.jump.module.pay.enums.PayChannelEnum;
import cn.jonhon.jump.module.pay.enums.refund.PayRefundStatusEnum;
import cn.jonhon.jump.module.pay.enums.transfer.PayTransferStatusEnum;
import cn.jonhon.jump.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO;
import cn.jonhon.jump.module.pay.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
import cn.jonhon.jump.module.pay.framework.pay.core.client.dto.refund.PayRefundRespDTO;
import cn.jonhon.jump.module.pay.framework.pay.core.client.dto.refund.PayRefundUnifiedReqDTO;
import cn.jonhon.jump.module.pay.framework.pay.core.client.dto.transfer.PayTransferRespDTO;
import cn.jonhon.jump.module.pay.framework.pay.core.client.dto.transfer.PayTransferUnifiedReqDTO;
import cn.jonhon.jump.module.pay.framework.pay.core.client.impl.AbstractPayClient;
import cn.jonhon.jump.module.pay.framework.pay.core.client.impl.NonePayClientConfig;
import cn.jonhon.jump.module.pay.dal.dataobject.order.PayOrderExtensionDO;
import cn.jonhon.jump.module.pay.dal.dataobject.refund.PayRefundDO;
import cn.jonhon.jump.module.pay.dal.dataobject.transfer.PayTransferDO;
import cn.jonhon.jump.module.pay.dal.dataobject.wallet.PayWalletTransactionDO;
import cn.jonhon.jump.module.pay.enums.order.PayOrderStatusEnum;
import cn.jonhon.jump.module.pay.enums.wallet.PayWalletBizTypeEnum;
import cn.jonhon.jump.module.pay.service.order.PayOrderService;
import cn.jonhon.jump.module.pay.service.refund.PayRefundService;
import cn.jonhon.jump.module.pay.service.transfer.PayTransferService;
import cn.jonhon.jump.module.pay.service.wallet.PayWalletService;
import cn.jonhon.jump.module.pay.service.wallet.PayWalletTransactionService;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static cn.jonhon.jump.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static cn.jonhon.jump.module.pay.enums.ErrorCodeConstants.PAY_ORDER_EXTENSION_NOT_FOUND;
import static cn.jonhon.jump.module.pay.enums.ErrorCodeConstants.REFUND_NOT_FOUND;
