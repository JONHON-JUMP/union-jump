package cn.jonhon.jump.module.mp.service.account;
...
import cn.jonhon.jump.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import cn.jonhon.jump.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import cn.jonhon.jump.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import cn.jonhon.jump.module.mp.convert.account.MpAccountConvert;
import cn.jonhon.jump.module.mp.dal.dataobject.account.MpAccountDO;
import cn.jonhon.jump.module.mp.dal.mysql.account.MpAccountMapper;
import cn.jonhon.jump.module.mp.enums.ErrorCodeConstants;
...
import static cn.jonhon.jump.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 jonhonjump-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
