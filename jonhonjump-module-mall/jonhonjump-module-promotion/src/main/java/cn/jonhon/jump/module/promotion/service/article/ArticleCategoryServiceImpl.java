...
import cn.jonhon.jump.module.promotion.controller.admin.article.vo.category.ArticleCategoryCreateReqVO;
import cn.jonhon.jump.module.promotion.controller.admin.article.vo.category.ArticleCategoryPageReqVO;
import cn.jonhon.jump.module.promotion.controller.admin.article.vo.category.ArticleCategoryUpdateReqVO;
import cn.jonhon.jump.module.promotion.convert.article.ArticleCategoryConvert;
import cn.jonhon.jump.module.promotion.dal.dataobject.article.ArticleCategoryDO;
import cn.jonhon.jump.module.promotion.dal.mysql.article.ArticleCategoryMapper;
...
import static cn.jonhon.jump.module.promotion.enums.ErrorCodeConstants.ARTICLE_CATEGORY_DELETE_FAIL_HAVE_ARTICLES;
