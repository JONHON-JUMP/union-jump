package cn.jonhon.jump.module.trade.controller.admin.config;

import cn.jonhon.jump.framework.common.pojo.CommonResult;
import cn.jonhon.jump.module.trade.controller.admin.config.vo.TradeConfigRespVO;
import cn.jonhon.jump.module.trade.controller.admin.config.vo.TradeConfigSaveReqVO;
import cn.jonhon.jump.module.trade.convert.config.TradeConfigConvert;
...
public class TradeConfigController {
    ...
    @Value("${jonhonjump.tencent-lbs-key}")
