...
import cn.jonhon.jump.framework.ip.core.utils.AreaUtils;
import cn.jonhon.jump.module.member.api.address.dto.MemberAddressRespDTO;
import cn.jonhon.jump.module.member.api.user.dto.MemberUserRespDTO;
import cn.jonhon.jump.module.pay.api.order.dto.PayOrderCreateReqDTO;
import cn.jonhon.jump.module.pay.enums.DictTypeConstants;
import cn.jonhon.jump.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import cn.jonhon.jump.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import cn.jonhon.jump.module.product.api.sku.dto.ProductSkuRespDTO;
import cn.jonhon.jump.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import cn.jonhon.jump.module.product.api.spu.dto.ProductSpuRespDTO;
import cn.jonhon.jump.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import cn.jonhon.jump.module.trade.api.order.dto.TradeOrderRespDTO;
import cn.jonhon.jump.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import cn.jonhon.jump.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import cn.jonhon.jump.module.trade.controller.admin.order.vo.*;
import cn.jonhon.jump.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import cn.jonhon.jump.module.trade.controller.app.order.vo.*;
import cn.jonhon.jump.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import cn.jonhon.jump.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import cn.jonhon.jump.module.trade.enums.order.TradeOrderItemAfterSaleStatusEnum;
import cn.jonhon.jump.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import cn.jonhon.jump.module.trade.framework.order.config.TradeOrderProperties;
import cn.jonhon.jump.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static cn.jonhon.jump.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static cn.jonhon.jump.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/jonhonjumpcode/jonhonjump-mall-uniapp/issues/ICY7SJ
