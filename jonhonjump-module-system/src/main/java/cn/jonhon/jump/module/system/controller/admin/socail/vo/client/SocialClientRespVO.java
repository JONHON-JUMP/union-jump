package cn.jonhon.jump.module.system.controller.admin.socail.vo.client;
...
public class SocialClientRespVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "jonhonjump商城")
    private String name;
