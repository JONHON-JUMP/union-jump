...
public interface SubSystemUsersMapper extends BaseMapperX<SubSystemUsersDO> {
    ...
    default PageResult<SubSystemUsersDO> selectPage(SubSystemUsersPageReqVO reqVO,
                                                     Collection<String> teamCodes,
                                                     Collection<Long> mainUserIds) {

        return selectPage(reqVO, new LambdaQueryWrapperX<SubSystemUsersDO>()
                ...
                .inIfPresent(SubSystemUsersDO::getMainUserId, mainUserIds)

                .eqIfPresent(SubSystemUsersDO::getStatus, reqVO.getStatus())
