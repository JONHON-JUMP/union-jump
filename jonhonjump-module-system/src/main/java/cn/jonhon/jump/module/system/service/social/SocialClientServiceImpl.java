package cn.jonhon.jump.module.system.service.social;
...
import cn.jonhon.jump.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.jonhon.jump.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import cn.jonhon.jump.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.jonhon.jump.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.jonhon.jump.module.system.dal.dataobject.social.SocialClientDO;
import cn.jonhon.jump.module.system.dal.mysql.social.SocialClientMapper;
...
import cn.jonhon.jump.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.jonhon.jump.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.jonhon.jump.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${jonhonjump.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${jonhonjump.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/jonhonjump-cloud/pulls/230
