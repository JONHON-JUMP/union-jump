package cn.jonhon.jump.module.system.framework.captcha.config;

import cn.jonhon.jump.module.system.framework.captcha.core.RedisCaptchaServiceImpl;
...
public class JonhonjumpCaptchaConfiguration {
