...
@Schema(description = "管理后台 - 外部系统角色分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
public class SubSystemRolePageReqVO extends PageParam {

    @Schema(description = "外部系统 ID", example = "1")
    private Long subSystemId;

    @Schema(description = "角色名称", example = "SCADA管理员")
    private String name;

    @Schema(description = "角色标识", example = "scada_admin")
    private String code;
