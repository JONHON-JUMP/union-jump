package cn.jonhon.jump.module.system.controller.admin.sms.vo.template;
...
public class SmsTemplateSaveReqVO {
    ...
    @Schema(description = "模板名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "jonhonjump")
