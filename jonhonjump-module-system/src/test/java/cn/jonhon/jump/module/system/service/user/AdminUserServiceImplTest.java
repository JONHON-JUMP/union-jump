...
import cn.jonhon.jump.framework.common.util.collection.ArrayUtils;
...
import cn.jonhon.jump.module.infra.api.config.ConfigApi;
import cn.jonhon.jump.module.infra.api.file.FileApi;
import cn.jonhon.jump.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.jonhon.jump.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.jonhon.jump.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.jonhon.jump.module.system.controller.admin.user.vo.user.UserImportRespVO;
...
import cn.jonhon.jump.module.system.dal.dataobject.dept.PostDO;
import cn.jonhon.jump.module.system.dal.dataobject.dept.UserPostDO;
...
import cn.jonhon.jump.module.system.dal.mysql.dept.UserPostMapper;
...
import cn.jonhon.jump.module.system.service.dept.PostService;
...
import static cn.jonhon.jump.framework.common.util.collection.SetUtils.asSet;
...
import static cn.jonhon.jump.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("jonhonjumpyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("jonhonjumpyuanma");
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("jonhonjumpyuanma"))).thenReturn("java");
