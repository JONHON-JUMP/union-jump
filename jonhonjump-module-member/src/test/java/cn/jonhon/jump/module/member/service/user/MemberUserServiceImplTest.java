...
import cn.jonhon.jump.module.member.controller.app.user.vo.AppMemberUserUpdateMobileReqVO;
...
import cn.jonhon.jump.module.member.service.auth.MemberAuthServiceImpl;
 ...
 */
@Disabled
@Import({MemberUserServiceImpl.class, JonhonjumpRedisAutoConfiguration.class})
