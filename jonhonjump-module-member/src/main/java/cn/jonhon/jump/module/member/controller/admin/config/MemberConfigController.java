package cn.jonhon.jump.module.member.controller.admin.config;

import cn.jonhon.jump.framework.common.pojo.CommonResult;
import cn.jonhon.jump.module.member.controller.admin.config.vo.MemberConfigRespVO;
import cn.jonhon.jump.module.member.controller.admin.config.vo.MemberConfigSaveReqVO;
import cn.jonhon.jump.module.member.convert.config.MemberConfigConvert;
import cn.jonhon.jump.module.member.dal.dataobject.config.MemberConfigDO;
import cn.jonhon.jump.module.member.service.config.MemberConfigService;
