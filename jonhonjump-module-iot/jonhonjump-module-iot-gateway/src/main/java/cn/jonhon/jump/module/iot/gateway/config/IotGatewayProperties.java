package cn.jonhon.jump.module.iot.gateway.config;

import cn.jonhon.jump.module.iot.core.enums.IotProtocolTypeEnum;
import cn.jonhon.jump.module.iot.gateway.protocol.coap.IotCoapConfig;
import cn.jonhon.jump.module.iot.gateway.protocol.emqx.IotEmqxConfig;
import cn.jonhon.jump.module.iot.gateway.protocol.http.IotHttpConfig;
import cn.jonhon.jump.module.iot.gateway.protocol.modbus.tcpclient.IotModbusTcpClientConfig;
import cn.jonhon.jump.module.iot.gateway.protocol.modbus.tcpserver.IotModbusTcpServerConfig;
import cn.jonhon.jump.module.iot.gateway.protocol.mqtt.IotMqttConfig;
import cn.jonhon.jump.module.iot.gateway.protocol.tcp.IotTcpConfig;
import cn.jonhon.jump.module.iot.gateway.protocol.udp.IotUdpConfig;
import cn.jonhon.jump.module.iot.gateway.protocol.websocket.IotWebSocketConfig;
import lombok.Data;
...
@ConfigurationProperties(prefix = "jonhonjump.iot.gateway")
@Validated
@Data
public class IotGatewayProperties {
    ...
    public static class ProtocolProperties {
         ...
         * 协议类型
         *
         * @see cn.jonhon.jump.module.iot.core.enums.IotProtocolTypeEnum
         */
         ...
         * 序列化类型（可选）
         *
         * @see cn.jonhon.jump.module.iot.core.enums.IotSerializeTypeEnum
         *
         * 为什么是可选的呢？
