package cn.jonhon.jump.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import cn.jonhon.jump.framework.common.exception.enums.GlobalErrorCodeConstants;
import cn.jonhon.jump.framework.common.pojo.CommonResult;
import cn.jonhon.jump.framework.common.util.json.JsonUtils;
import cn.jonhon.jump.module.iot.core.biz.IotDeviceCommonApi;
import cn.jonhon.jump.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import cn.jonhon.jump.module.iot.core.biz.dto.IotDeviceRespDTO;
import cn.jonhon.jump.module.iot.core.biz.dto.IotModbusDeviceConfigRespDTO;
import cn.jonhon.jump.module.iot.core.biz.dto.IotModbusPointRespDTO;
import cn.jonhon.jump.module.iot.core.enums.IotDeviceMessageMethodEnum;
import cn.jonhon.jump.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
import cn.jonhon.jump.module.iot.core.mq.message.IotDeviceMessage;
import cn.jonhon.jump.module.iot.core.topic.IotDeviceIdentity;
import cn.jonhon.jump.module.iot.core.util.IotDeviceAuthUtils;
import cn.jonhon.jump.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import cn.jonhon.jump.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import cn.jonhon.jump.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import cn.jonhon.jump.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import cn.jonhon.jump.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import cn.jonhon.jump.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import cn.jonhon.jump.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import cn.jonhon.jump.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import cn.jonhon.jump.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import cn.jonhon.jump.module.iot.gateway.service.device.IotDeviceService;
import cn.jonhon.jump.module.iot.gateway.service.device.message.IotDeviceMessageService;
...
import static cn.jonhon.jump.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static cn.jonhon.jump.framework.common.exception.util.ServiceExceptionUtil.invalidParamException;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link cn.jonhon.jump.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
