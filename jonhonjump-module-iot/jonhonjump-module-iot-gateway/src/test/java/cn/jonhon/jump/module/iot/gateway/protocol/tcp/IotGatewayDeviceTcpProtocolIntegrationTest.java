package cn.jonhon.jump.module.iot.gateway.protocol.tcp;
...
import cn.jonhon.jump.module.iot.core.topic.topo.IotDeviceTopoGetReqDTO;
import cn.jonhon.jump.module.iot.core.util.IotDeviceAuthUtils;
import cn.jonhon.jump.module.iot.gateway.protocol.tcp.codec.IotTcpCodecTypeEnum;
import cn.jonhon.jump.module.iot.gateway.protocol.tcp.codec.IotTcpFrameCodec;
import cn.jonhon.jump.module.iot.gateway.protocol.tcp.codec.IotTcpFrameCodecFactory;
import cn.jonhon.jump.module.iot.gateway.serialize.IotMessageSerializer;
import cn.jonhon.jump.module.iot.gateway.serialize.json.IotJsonSerializer;
 ...
 * <p>使用步骤：
 * <ol>
 *     <li>启动 jonhonjump-module-iot-gateway 服务（TCP 端口 8091）</li>
 *     <li>运行以下测试方法：
 *         <ul>
