package cn.jonhon.jump.module.iot.job.device;
...
import cn.jonhon.jump.module.iot.framework.iot.config.JonhonjumpIotProperties;
...
public class IotDeviceOfflineCheckJob implements JobHandler {
    ...
    @Resource
    private JonhonjumpIotProperties iotProperties;
