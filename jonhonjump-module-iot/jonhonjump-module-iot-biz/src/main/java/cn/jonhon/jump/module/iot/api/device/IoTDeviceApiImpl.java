package cn.jonhon.jump.module.iot.api.device;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.ObjUtil;
import cn.hutool.core.util.StrUtil;
import cn.jonhon.jump.framework.common.enums.RpcConstants;
...
import cn.jonhon.jump.module.iot.core.biz.dto.*;
...
import cn.jonhon.jump.module.iot.dal.dataobject.device.IotDeviceModbusPointDO;
import cn.jonhon.jump.module.iot.dal.dataobject.product.IotProductDO;
import cn.jonhon.jump.module.iot.service.device.IotDeviceModbusConfigService;
import cn.jonhon.jump.module.iot.service.device.IotDeviceModbusPointService;
...
@RestController
@Validated
@Primary // 保证优先匹配，因为 jonhonjump-iot-gateway 也有 IotDeviceCommonApi 的实现，并且也可能会被 biz 引入
