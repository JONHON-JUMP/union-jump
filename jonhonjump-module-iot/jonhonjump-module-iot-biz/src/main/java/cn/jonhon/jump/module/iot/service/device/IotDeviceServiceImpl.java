package cn.jonhon.jump.module.iot.service.device;
...
import cn.jonhon.jump.module.iot.controller.admin.device.vo.device.*;
import cn.jonhon.jump.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import cn.jonhon.jump.module.iot.core.biz.dto.IotSubDeviceRegisterFullReqDTO;
import cn.jonhon.jump.module.iot.core.enums.IotDeviceMessageMethodEnum;
import cn.jonhon.jump.module.iot.core.enums.device.IotDeviceStateEnum;
...
import cn.jonhon.jump.module.iot.core.topic.auth.IotDeviceRegisterReqDTO;
import cn.jonhon.jump.module.iot.core.topic.auth.IotDeviceRegisterRespDTO;
import cn.jonhon.jump.module.iot.core.topic.auth.IotSubDeviceRegisterReqDTO;
import cn.jonhon.jump.module.iot.core.topic.auth.IotSubDeviceRegisterRespDTO;
import cn.jonhon.jump.module.iot.core.topic.topo.IotDeviceTopoAddReqDTO;
import cn.jonhon.jump.module.iot.core.topic.topo.IotDeviceTopoChangeReqDTO;
import cn.jonhon.jump.module.iot.core.topic.topo.IotDeviceTopoDeleteReqDTO;
import cn.jonhon.jump.module.iot.core.topic.topo.IotDeviceTopoGetRespDTO;
import cn.jonhon.jump.module.iot.core.util.IotDeviceAuthUtils;
import cn.jonhon.jump.module.iot.core.util.IotProductAuthUtils;
import cn.jonhon.jump.module.iot.dal.dataobject.device.IotDeviceDO;
import cn.jonhon.jump.module.iot.dal.dataobject.device.IotDeviceGroupDO;
import cn.jonhon.jump.module.iot.dal.dataobject.product.IotProductDO;
import cn.jonhon.jump.module.iot.dal.mysql.device.IotDeviceMapper;
import cn.jonhon.jump.module.iot.dal.redis.RedisKeyConstants;
import cn.jonhon.jump.module.iot.enums.product.IotProductDeviceTypeEnum;
import cn.jonhon.jump.module.iot.service.device.message.IotDeviceMessageService;
import cn.jonhon.jump.module.iot.service.product.IotProductService;
...
import static cn.jonhon.jump.module.iot.enums.ErrorCodeConstants.*;
