...
import cn.jonhon.jump.module.mes.controller.admin.pro.task.vo.MesProTaskIssueRespVO;
import cn.jonhon.jump.module.mes.controller.admin.pro.task.vo.MesProTaskIssueSaveReqVO;
...
public class MesProTaskIssueController {
    ...
    private List<MesProTaskIssueRespVO> buildIssueRespVOList(List<MesProTaskIssueDO> list) {
        ...
        // 拼接 VO
        return cn.jonhon.jump.framework.common.util.collection.CollectionUtils.convertList(list, issue -> {
