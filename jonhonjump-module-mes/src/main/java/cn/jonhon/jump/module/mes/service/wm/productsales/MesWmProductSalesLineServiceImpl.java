...
import cn.jonhon.jump.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO;
import cn.jonhon.jump.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLineSaveReqVO;
...
import cn.jonhon.jump.module.mes.dal.mysql.wm.productsales.MesWmProductSalesLineMapper;
import cn.jonhon.jump.module.mes.enums.qc.MesQcCheckResultEnum;
...
import cn.jonhon.jump.module.mes.service.wm.salesnotice.MesWmSalesNoticeLineService;
...
public class MesWmProductSalesLineServiceImpl implements MesWmProductSalesLineService {
    ...
    @Override
    public cn.jonhon.jump.framework.common.pojo.PageResult<MesWmProductSalesLineDO> getProductSalesLinePage(
        ...
        if (pageReqVO.getSalesId() == null && pageReqVO.getClientId() != null) {
            ...
            if (CollUtil.isEmpty(salesList)) {
                return cn.jonhon.jump.framework.common.pojo.PageResult.empty();
            }
