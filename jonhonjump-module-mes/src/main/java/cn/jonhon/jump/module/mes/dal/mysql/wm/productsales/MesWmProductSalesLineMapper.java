package cn.jonhon.jump.module.mes.dal.mysql.wm.productsales;
...
public interface MesWmProductSalesLineMapper extends BaseMapperX<MesWmProductSalesLineDO> {
    ...
    default cn.jonhon.jump.framework.common.pojo.PageResult<MesWmProductSalesLineDO> selectPage(
            cn.jonhon.jump.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO reqVO) {
        return selectPage(reqVO, new cn.jonhon.jump.framework.mybatis.core.query.LambdaQueryWrapperX<MesWmProductSalesLineDO>()
