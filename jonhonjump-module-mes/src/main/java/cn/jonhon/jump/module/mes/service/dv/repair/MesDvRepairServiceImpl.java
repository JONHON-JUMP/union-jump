package cn.jonhon.jump.module.mes.service.dv.repair;
...
import cn.jonhon.jump.module.mes.dal.mysql.dv.repair.MesDvRepairMapper;
import cn.jonhon.jump.module.mes.enums.dv.MesDvRepairStatusEnum;
...
public class MesDvRepairServiceImpl implements MesDvRepairService {
    ...
    @Override
    public void confirmRepair(cn.jonhon.jump.module.mes.controller.admin.dv.repair.vo.MesDvRepairConfirmReqVO confirmReqVO) {
        // 1. 校验存在，且状态为维修中
