package cn.jonhon.jump.framework.desensitize.core;

import cn.jonhon.jump.framework.common.util.json.JsonUtils;
import cn.jonhon.jump.framework.desensitize.core.annotation.Address;
import cn.jonhon.jump.framework.desensitize.core.regex.annotation.EmailDesensitize;
import cn.jonhon.jump.framework.desensitize.core.regex.annotation.RegexDesensitize;
import cn.jonhon.jump.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("中航光电");
        ...
        desensitizeDemo.setRegex("你好，我是中航光电");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("中航光电");

        // 调用
        DesensitizeDemo d = JsonUtils.parseObject(JsonUtils.toJsonString(desensitizeDemo), DesensitizeDemo.class);
        // 断言
        assertNotNull(d);
        assertEquals("中***", d.getNickname());
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "中航光电", replacer = "*")
