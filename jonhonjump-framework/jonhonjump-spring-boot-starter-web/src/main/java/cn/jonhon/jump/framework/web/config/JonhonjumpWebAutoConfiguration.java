package cn.jonhon.jump.framework.web.config;
...
import cn.jonhon.jump.framework.web.core.filter.CacheRequestBodyFilter;
import cn.jonhon.jump.framework.web.core.filter.DemoFilter;
import cn.jonhon.jump.framework.web.core.handler.GlobalExceptionHandler;
import cn.jonhon.jump.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class JonhonjumpWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "jonhonjump.demo", havingValue = "true")
