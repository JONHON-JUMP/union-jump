...
public class BannerApplicationRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ThreadUtil.execute(() -> {
            ...
            // 数据报表
            if (isNotPresent("cn.jonhon.jump.module.report.framework.security.config.SecurityConfiguration")) {
                System.out.println("[报表模块 jonhonjump-module-report - 已禁用][参考 https://doc.iocoder.cn/report/ 开启]");
            }
            // 工作流
            ...
            if (isNotPresent("cn.jonhon.jump.module.ai.framework.web.config.AiWebConfiguration")) {
                System.out.println("[AI 大模型 jonhonjump-module-ai - 已禁用][参考 https://doc.iocoder.cn/ai/build/ 开启]");
            }
            // IoT 物联网
            if (isNotPresent("cn.jonhon.jump.module.iot.framework.web.config.IotWebConfiguration")) {
                System.out.println("[IoT 物联网 jonhonjump-module-iot - 已禁用][参考 https://doc.iocoder.cn/iot/build/ 开启]");
            }
        });
    }
