package cn.jonhon.jump.framework.jackson.config;

import cn.jonhon.jump.framework.common.util.json.JsonUtils;
import cn.jonhon.jump.framework.common.util.json.databind.NumberSerializer;
import cn.jonhon.jump.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import cn.jonhon.jump.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class JonhonjumpJacksonAutoConfiguration {
