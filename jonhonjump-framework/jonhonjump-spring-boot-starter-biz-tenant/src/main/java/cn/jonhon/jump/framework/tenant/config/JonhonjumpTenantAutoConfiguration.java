package cn.jonhon.jump.framework.tenant.config;

import cn.jonhon.jump.framework.common.biz.system.tenant.TenantCommonApi;
...
import cn.jonhon.jump.framework.redis.config.JonhonjumpCacheProperties;
import cn.jonhon.jump.framework.security.core.service.SecurityFrameworkService;
import cn.jonhon.jump.framework.tenant.core.aop.TenantIgnore;
import cn.jonhon.jump.framework.tenant.core.aop.TenantIgnoreAspect;
import cn.jonhon.jump.framework.tenant.core.db.TenantDatabaseInterceptor;
import cn.jonhon.jump.framework.tenant.core.job.TenantJobAspect;
import cn.jonhon.jump.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import cn.jonhon.jump.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import cn.jonhon.jump.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import cn.jonhon.jump.framework.tenant.core.redis.TenantRedisCacheManager;
import cn.jonhon.jump.framework.tenant.core.security.TenantSecurityWebFilter;
import cn.jonhon.jump.framework.tenant.core.service.TenantFrameworkService;
import cn.jonhon.jump.framework.tenant.core.service.TenantFrameworkServiceImpl;
import cn.jonhon.jump.framework.tenant.core.web.TenantContextWebFilter;
import cn.jonhon.jump.framework.tenant.core.web.TenantVisitContextInterceptor;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "jonhonjump.tenant", value = "enable", matchIfMissing = true) // 允许使用 jonhonjump.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class JonhonjumpTenantAutoConfiguration {
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     JonhonjumpCacheProperties jonhonjumpCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(jonhonjumpCacheProperties.getRedisScanBatchSize()));
