package cn.jonhon.jump.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${jonhonjump.websocket.sender-rocketmq.topic}",
        consumerGroup = "${jonhonjump.websocket.sender-rocketmq.consumer-group}",
