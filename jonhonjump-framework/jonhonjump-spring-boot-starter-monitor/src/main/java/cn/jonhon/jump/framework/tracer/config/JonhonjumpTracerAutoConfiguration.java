...
import cn.jonhon.jump.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "jonhonjump.tracer", value = "enable", matchIfMissing = true)
public class JonhonjumpTracerAutoConfiguration {
