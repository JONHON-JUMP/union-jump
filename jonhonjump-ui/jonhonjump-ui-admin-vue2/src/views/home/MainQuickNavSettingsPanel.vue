...
import { getUserQuickNavCandidates, getUserQuickNavList } from '@/api/system/user/quickNav'
import { SystemMenuTypeEnum } from '@/utils/constants'

export default {
  name: 'MainQuickNavSettingsPanel',
  ...
  methods: {
    loadData() {
      this.loading = true
      this.keyword = ''
      return Promise.all([getUserQuickNavList(), getUserQuickNavCandidates()])
