...
import cn.jonhon.jump.module.bpm.controller.admin.base.dept.DeptSimpleBaseVO;
...
public class BpmModelRespVO extends BpmModelMetaInfoVO {
    ...
    @Schema(description = "流程标识", requiredMode = Schema.RequiredMode.REQUIRED, example = "process_jonhonjump")
    private String key;

    @Schema(description = "流程名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "芋道")
    private String name;

    @Schema(description = "流程图标", example = "https://www.iocoder.cn/jonhonjump.jpg")
    private String icon;
