package cn.jonhon.jump.module.ai.framework.ai.core.model;
...
import cn.jonhon.jump.framework.common.util.spring.SpringUtils;
import cn.jonhon.jump.module.ai.enums.model.AiPlatformEnum;
import cn.jonhon.jump.module.ai.framework.ai.config.AiAutoConfiguration;
import cn.jonhon.jump.module.ai.framework.ai.config.JonhonjumpAiProperties;
...
import cn.jonhon.jump.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.jonhon.jump.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            JonhonjumpAiProperties.Midjourney properties = SpringUtil.getBean(JonhonjumpAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(JonhonjumpAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        JonhonjumpAiProperties.DouBao properties = new JonhonjumpAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(JonhonjumpAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        JonhonjumpAiProperties.HunYuan properties = new JonhonjumpAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(JonhonjumpAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        JonhonjumpAiProperties.SiliconFlow properties = new JonhonjumpAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(JonhonjumpAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        JonhonjumpAiProperties.XingHuo properties = new JonhonjumpAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(JonhonjumpAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        JonhonjumpAiProperties.BaiChuan properties = new JonhonjumpAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(JonhonjumpAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        JonhonjumpAiProperties.Gemini properties = SpringUtil.getBean(JonhonjumpAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        JonhonjumpAiProperties.Grok properties = new JonhonjumpAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
