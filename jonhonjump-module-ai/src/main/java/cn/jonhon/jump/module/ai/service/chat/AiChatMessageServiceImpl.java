package cn.jonhon.jump.module.ai.service.chat;
...
import cn.jonhon.jump.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import cn.jonhon.jump.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import cn.jonhon.jump.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import cn.jonhon.jump.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import cn.jonhon.jump.module.ai.dal.dataobject.chat.AiChatConversationDO;
import cn.jonhon.jump.module.ai.dal.dataobject.chat.AiChatMessageDO;
import cn.jonhon.jump.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import cn.jonhon.jump.module.ai.dal.dataobject.model.AiChatRoleDO;
import cn.jonhon.jump.module.ai.dal.dataobject.model.AiModelDO;
import cn.jonhon.jump.module.ai.dal.dataobject.model.AiToolDO;
import cn.jonhon.jump.module.ai.dal.mysql.chat.AiChatMessageMapper;
import cn.jonhon.jump.module.ai.enums.ErrorCodeConstants;
...
import cn.jonhon.jump.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import cn.jonhon.jump.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import cn.jonhon.jump.module.ai.service.knowledge.AiKnowledgeDocumentService;
import cn.jonhon.jump.module.ai.service.knowledge.AiKnowledgeSegmentService;
import cn.jonhon.jump.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import cn.jonhon.jump.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import cn.jonhon.jump.module.ai.service.model.AiChatRoleService;
import cn.jonhon.jump.module.ai.service.model.AiModelService;
import cn.jonhon.jump.module.ai.service.model.AiToolService;
import cn.jonhon.jump.module.ai.util.AiUtils;
import cn.jonhon.jump.module.ai.util.FileTypeUtils;
...
import static cn.jonhon.jump.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static cn.jonhon.jump.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 jonhonjump.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 jonhonjump.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
