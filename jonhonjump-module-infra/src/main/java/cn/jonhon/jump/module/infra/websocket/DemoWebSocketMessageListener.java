package cn.jonhon.jump.module.infra.websocket;
...
import cn.jonhon.jump.framework.websocket.core.util.WebSocketFrameworkUtils;
import cn.jonhon.jump.module.infra.websocket.message.DemoReceiveMessage;
import cn.jonhon.jump.module.infra.websocket.message.DemoSendMessage;
...
public class DemoWebSocketMessageListener implements WebSocketMessageListener<DemoSendMessage> {
    ...
    @Autowired(required = false) // 由于 jonhonjump.websocket.enable 配置项，可以关闭 WebSocket 的功能，所以这里只能不强制注入
