...
import cn.jonhon.jump.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.jonhon.jump.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.jonhon.jump.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.jonhon.jump.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.jonhon.jump.module.infra.dal.dataobject.logger.ApiErrorLogDO.REQUEST_PARAMS_MAX_LENGTH;
import static cn.jonhon.jump.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.jonhon.jump.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImpl implements ApiErrorLogService {
    ...
    public void createApiErrorLog(ApiErrorLogCreateReqDTO createDTO) {
        ...
        try {
            ...
            // 兜底处理，目前只有 jonhonjump-cloud 会发生：https://gitee.com/jonhonjumpcode/jonhonjump-cloud-mini/issues/IC1O0A
