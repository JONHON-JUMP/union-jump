package cn.jonhon.jump.module.infra.controller.admin.codegen;
...
import cn.jonhon.jump.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import cn.jonhon.jump.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import cn.jonhon.jump.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import cn.jonhon.jump.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.jonhon.jump.module.infra.convert.codegen.CodegenConvert;
...
import cn.jonhon.jump.module.infra.service.codegen.CodegenService;
...
import static cn.jonhon.jump.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static cn.jonhon.jump.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "jonhonjump"),
