...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.jonhon.jump.boot";
    private static final String ARTIFACT_ID = "jonhonjump";
    private static final String PACKAGE_NAME = "cn.jonhon.jump";
    private static final String TITLE = "中航MES统一门户系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.jonhon.jump.boot";
        String artifactIdNew = "jonhonjump";
        String packageNameNew = "cn.jonhon.jump";
        String titleNew = "中航MES统一门户系统";
