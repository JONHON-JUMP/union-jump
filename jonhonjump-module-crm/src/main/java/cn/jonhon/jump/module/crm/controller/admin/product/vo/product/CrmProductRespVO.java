package cn.jonhon.jump.module.crm.controller.admin.product.vo.product;
...
import cn.jonhon.jump.module.crm.enums.DictTypeConstants;
...
public class CrmProductRespVO implements VO {
    ...
    @Trans(type = TransType.SIMPLE, targetClassName = "cn.jonhon.jump.module.system.dal.dataobject.user.AdminUserDO",
            fields = "nickname", ref = "ownerUserName")
    private Long ownerUserId;
    @Schema(description = "负责人的用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "中航光电")
    @ExcelProperty("负责人")
    ...
    @Schema(description = "创建人名字", requiredMode = Schema.RequiredMode.REQUIRED, example = "中航光电")
    @ExcelProperty("创建人")
